...
import { Loader2, Trash2, X, AlertTriangle, FileText } from "lucide-react"
...
export function DeleteTaskModal({
  ...
  const statusInfo = taskStatus ? statusConfig[taskStatus] : null
  const priorityInfo = taskPriority ? priorityConfig[taskPriority] : null
          ...
          <div className="flex items-start gap-4 p-5 bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 rounded-xl border-2 border-red-200 dark:border-red-800 shadow-sm">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-red-700 dark:text-red-300">
                سيتم حذف المهمة بشكل نهائي من النظام. لا يمكن استعادة البيانات المحذوفة.
              </p>
            </div>
          </div>
          ...
          <div className="p-5 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900/50 dark:to-gray-800/50 rounded-xl border-2 border-gray-200 dark:border-gray-700 shadow-sm">
            <div className="flex items-start gap-4">
              <div className="p-3 rounded-lg bg-primary/10 dark:bg-primary/20 border border-primary/20">
                <FileText className="h-6 w-6 text-primary dark:text-[#E2C992] drop-shadow-[0_0_2px_rgba(226,201,146,0.3)]" />
              </div>
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  <FileText className="h-4 w-4 text-gray-500 dark:text-gray-400" />
                  <span className="text-sm text-gray-500 dark:text-gray-400">المهمة</span>
                </div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-3">
                  سيتم حذف هذه المهمة بشكل نهائي
                </p>
              </div>
            </div>
          </div>
